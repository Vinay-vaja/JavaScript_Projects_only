...
form.addEventListener("submit",(e)=>{
    ...
    const text = `Hii ${name} ${surname} your zodiacSigns is ${zodiacSigns[month-1]}.
    . ${compliments[day-1]}. ${victimCardCompliments[(day*month)%20]}.${recommendations[(name.length*year)%30]}. ${predictions[(surname.length*year)%20]}
    `;
